...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://github.com/SLJaNa/SL_Jana_Telegram-Leecher_Bot")
    buttons.buildbutton("Owner-SL_Jana_Team", "https://github.com/SLJaNa")
...
help = telegraph.create_page(
        title='SL_Jana_Telegram-Leecher_Bot Help',
